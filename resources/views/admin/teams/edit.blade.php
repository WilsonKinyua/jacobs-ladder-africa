    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.teams.update", [$team->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('intro_caption') ? 'is-invalid' : '' }}" name="intro_caption" id="intro_caption">{!! old('intro_caption', $team->intro_caption) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('user_bio') ? 'is-invalid' : '' }}" name="user_bio" id="user_bio">{!! old('user_bio', $team->user_bio) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('twitter_url') ? 'is-invalid' : '' }}" name="twitter_url" id="twitter_url">{{ old('twitter_url', $team->twitter_url) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('linkedin_url') ? 'is-invalid' : '' }}" name="linkedin_url" id="linkedin_url">{{ old('linkedin_url', $team->linkedin_url) }}</textarea>
