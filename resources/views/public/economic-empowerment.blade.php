...
<body>
    ...
    <div class="push-top-header">
        <div class="sections" style="background-image: url('./img/education.jpeg');">
            <div class="container">
                <div class="pages-title">
                    ...
                    <p><a href="/">Home</a> &nbsp; > &nbsp; <a href="./our-pillars.html">Our Pillars</a>
                        &nbsp; > &nbsp; <a class="active" href="./economic-empowerment.html">Economic Empowerment</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="mt-5 mb-5">
        <div class="container">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="./img/economic.jpg" class="img-fluid rounded-start" alt="Leadership">
                </div>
