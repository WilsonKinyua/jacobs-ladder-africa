        ...
        <div class="container">
            <div class="row hover-effects-zoom-in image-hover">
                <div class="col-md-6 col-lg-6">
                    <div class="pillars-box">
                        <figure class="pillars-thumbnail">
                            <iframe style="width: 100%;height:310px; object-fit:fill"
                                src="https://www.youtube.com/embed/xCwmAPHidz0"
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="pillars-box">
                        <figure class="pillars-thumbnail">
                            <iframe style="width: 100%; height:330px;" frameborder="0"
                                src="https://www.bbc.co.uk/programmes/p0cn071t/player"></iframe>
                        </figure>
                        <div class="pillars-short-desc">
                            <h3>
